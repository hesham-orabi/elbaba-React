...
import OffersProducts from '../api/OffersProducts.json';

class OffersProduct extends React.Component {

    state= {
        allProducts: OffersProducts,
        product:{},
        quantity: 1
    }
                    ...
                    <div className='product-page-title'>
                        <div className='row'>
                            <div className='col-12 text-left'>
                                ...
                                <Link to='/mobile-accessories'>Offers</Link>&nbsp;&nbsp;&nbsp;
                                <i className="fas fa-play"></i>&nbsp;&nbsp;&nbsp;
                                <p>{myProduct.name}</p>
                            </div>
                        </div>
...
export default connect(null,mapDispatchToProps) (OffersProduct);
